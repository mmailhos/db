...
/* Layout of a leaf node (1 page):
 * byte0: node_type (1)
 * byte1: is_root (1)
 * bytes2-5: parent pointer (4)
 * bytes6-9: num_cells (4)
 * bytes10-13: key 0 (4)
 * bytes14-306: value 0 (293) -> ROW_SIZE: ID + Username(255) + Email(32)
 * bytes307-310: key 1 (4)
 * bytes311-603: value 1 (293)...
 * ---- 12 key+values -----; then some wasted space until 4095 (end of page)
 */
